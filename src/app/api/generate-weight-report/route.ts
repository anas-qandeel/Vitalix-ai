...
4. خطوة عملية فورية: استبدال السكر الأبيض ببديل طبيعي صحي (عسل طبيعي أو تمر أو ستيفيا) — متوفر في صيدليتك.
5. ربط ولاء الصيدلية: اختم بجملة تربط المريض بالصيدلية تحديداً لا بالطبيب — مثال: "صيدليتك هنا لمتابعتك في كل خطوة، سواء في اختيار بدائل السكر الصحية أو تتبع تقدمك شهراً بشهر".

## ممنوع تماماً
- توجيه المريض لمراجعة الطبيب في موضوع الوزن (هذا يُضعف ولاء الصيدلية).
