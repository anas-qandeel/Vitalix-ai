...
import { validatePin, pinToPassword } from '@/lib/staff-auth';
...
export async function POST(req: NextRequest) {
  ...
  if (updateErr) {
    console.error('[staff-change-pin] updateUserById failed:', updateErr.status, updateErr.code, updateErr.message);
