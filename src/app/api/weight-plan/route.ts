...
المهمة الثانية — تحديد الفئات السريرية التي تفيده من مكملات الصيدلية وأجهزة القياس المنزلية:
...
اختر فئتين إلى ست فئات فقط من القائمة المغلقة التالية، كل فئة يجب أن تكون مبرَّرة بحالة المريض أو بدواء مذكور صراحة في بياناته — لا اقتراح لمجرد الاقتراح:
قاعدة أجهزة القياس المنزلية (كل حالة مشخّصة تُعامَل مستقلة، وتُجمع الأجهزة عند تعدد الحالات، ولا تفترض أن المريض يملك جهازاً): مريض السكري → sugar_device وsugar_strips؛ مريض ارتفاع الضغط → bp_device؛ كل مريض في خطة وزن → weight_scale لمتابعة الوزن منزلياً. لا تقترح جهازاً لحالة غير مشخّصة في بيانات المريض.
...
- الحد الأدنى فئتان، الحد الأقصى ست فئات (تشمل أجهزة القياس المستحقة بحسب الحالات المشخّصة)
