  ...
  return (
    <div className="min-h-screen bg-slate-50/50 antialiased text-slate-900 pb-20" dir="rtl">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 pt-8 pb-12 space-y-8">
        ...
        <div className="fu1 bg-white border border-slate-200 rounded-2xl relative overflow-hidden shadow-sm flex flex-col lg:flex-row">
        ...
        {/* ═══ 3. بطاقات التنقل ═══ */}
        <div className="fu3 grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* الفحوصات */}
        ...
        {todayAlerts.length > 0 && (
          <div className="fu4 bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
            <div className="px-6 py-5 border-b border-slate-100 bg-slate-50/50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-semibold text-slate-900">تذكيرات الأدوية المزمنة</h3>
