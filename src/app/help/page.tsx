  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>عرض افتراضي لاسم الصيدلية، الاسم بالإنجليزية، اسم الصيدلاني، الهاتف، الدولة، المدينة/العنوان، البريد الإلكتروني، و<span className="font-bold">كود الصيدلية</span> (الذي يحتاجه الموظفون لتسجيل الدخول) مع زرَّي &quot;نسخ&quot; و&quot;تبديل&quot;. زر &quot;✏️ تعديل&quot; يفتح نموذجاً لتغيير: اسم الصيدلاني، الهاتف، المدينة/العنوان، الاسم بالإنجليزية (اختياري، يُستخدم في التقارير والرسائل الإنجليزية).</p>
        <div className="mt-3">
          <Callout>
