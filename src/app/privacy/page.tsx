        ...
        <div className="mt-6 bg-white border border-slate-200/80 rounded-[22px] shadow-[0_20px_50px_rgba(15,23,42,0.04)] p-8 sm:p-10 space-y-8">
          ...
          <Section title="كيف نستخدم البيانات">
            <ul className="list-disc list-inside space-y-1.5">
              <li>لعرض سجل المريض وتاريخ فحوصاته للصيدلاني الذي يتابعه.</li>
              <li>لحساب مواعيد نفاذ الأدوية المزمنة وتذكير الصيدلية بها.</li>
              <li>لتوليد ملخصات وبطاقات أمان للمنتجات بمساعدة الذكاء الاصطناعي.</li>
              <li>لإرسال روابط تُطلعك أنت أو مريضك على نتيجة فحص أو خطة، يشاركها الصيدلاني يدوياً.</li>
            </ul>
          ...
          <Section title="مشاركة البيانات مع أطراف أخرى">
            ...
            <ul className="space-y-3">
              ...
              <li><span className="font-bold text-slate-800">Google Gemini</span> — عند بناء بطاقة أمان أو ملخص فحص، تُرسَل البيانات ذات الصلة إليه لمعالجتها، فقط عند طلب الصيدلاني ذلك صراحة.</li>
